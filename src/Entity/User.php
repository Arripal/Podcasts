...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: Podcast::class, mappedBy: 'author')]
    ...
    public function addSubscription(self $user): self
    {
